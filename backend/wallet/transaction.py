...
class Transaction:
    ...
    def update(self, sender_wallet, recipient, amount):
        """
        Update the transaction with a existing or new recipient.
        """
    ...
    def from_json(transaction_json):
        """
        Deserialise the transaction back into Transaction instance
        """
        # return Transaction(
...
def main():
    ...
    print(f'transaction.dict: {restored_transaction_json.__dict__}')
